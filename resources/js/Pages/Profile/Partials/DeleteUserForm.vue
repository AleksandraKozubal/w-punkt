  ...
  <section class="space-y-6">
    <header>
      ...
      <p class="mt-1 text-sm text-gray-600">
        Po usunięciu Twojego konta wszystkie jego zasoby i dane zostaną trwale usunięte. Przed usunięciem
        swojego konta, pobierz wszelkie dane lub informacje, które chcesz zachować.
      </p>
    </header>
    ...
    <Modal :show="confirmingUserDeletion" @close="closeModal">
      <div class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600">
          Proszę wprowadź swoje hasło, aby potwierdzić, że chcesz trwale usunąć swoje konto.
        </p>
