...
const submitForm = () => {
  form.post(route('series.store'), {
    ...
    onError: () => {
      toast.error('Wystąpił błąd podczas dodawania serii.')
    },
  })
}
              ...
              <div v-for="(target, index) in form.targets" :key="index" class="flex flex-col gap-2">
                ...
                <div class="flex gap-2">
                  ...
                  <div class="flex flex-col gap-2">
                    ...
                    <div>
                      <span class="font-semibold">Wynik:</span> {{ target.pointsEarned }}/{{ target.pointsMax }}
                    </div>
                    <div>
                      <span class="font-semibold">Centralne dziesiątki:</span> {{ target.centerHits }}
                    </div>
